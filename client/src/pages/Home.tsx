                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
                  ...
                  <div className="bg-white dark:bg-gray-900 rounded-lg md:rounded-xl p-3 sm:p-4 md:p-6 border border-gray-200">
                    <div className="text-center">
                      ...
                      <div className="text-xl sm:text-2xl md:text-3xl font-bold text-red-600 mb-1 md:mb-2">13% / 2.35%</div>
                      <div className="text-[10px] md:text-xs text-gray-600 dark:text-gray-400 mb-1">13% first $7.5K</div>
                      <div className="text-[10px] md:text-xs text-gray-600 dark:text-gray-400 mb-2 md:mb-4">2.35% above $7.5K</div>
                    </div>
                  </div>
